...
public class AddEmployeeSchedule implements ICalendarScreen {
  ...
  public void displayScreen() {
    ...
    try {
      ...
      CalendarEvent calendarEvent = new CalendarEvent(event_name, event_desc,
          eventDate, empID, managerID, 1);
      InsertCalendarEventE.insertEvent(calendarEvent);
    } catch (Exception e) {
      e.printStackTrace();
    }

    System.out.println("Event added successfully to employee's calendar");
